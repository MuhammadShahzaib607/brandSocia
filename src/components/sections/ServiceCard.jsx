...
function ServiceCard({ service, index, isVisible, cardVariants }) {
  ...
  const serviceImages = [
    '/services/Gemini_Generated_Image_5a2z8q5a2z8q5a2z.png', // service 1
    '/services/Gemini_Generated_Image_5a2z8q5a2z8q5a2z (1).png', // service 2
    '/services/Gemini_Generated_Image_5a2z8q5a2z8q5a2z (2).png'  // service 3
  ]
    ...
    <motion.div variants={cardVariants} className="h-full">
      <Card
        className={`h-full overflow-hidden rounded-2xl transition-all duration-300 ${
          isHovered ? 'shadow-lg transform -translate-y-1 bg-orange-500' : 'shadow bg-white'
        }`}
      ...
      >
        ...
        <div className="relative h-48 w-full">
          ...
          <div className={`absolute inset-0 flex items-center justify-center transition-colors duration-300 ${
            isHovered ? 'bg-orange-500 bg-opacity-80' : 'bg-transparent bg-opacity-40'
          }`}>
          </div>
        </div>
        ...
        <div className="p-6">
          ...
          <Link
            ...
            className={`font-medium inline-flex items-center transition-colors duration-300 ${
              isHovered ? 'text-white hover:text-gray-100' : 'text-primary-600 hover:text-primary-700'
            }`}
          >
            Learn More
