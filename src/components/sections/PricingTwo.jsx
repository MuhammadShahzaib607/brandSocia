    ...
    <section className="relative py-16 bg-cover bg-center bg-no-repeat  rounded-md" > 
      ...
      <div className="container mx-auto px-4 relative z-10">
              ...
              {plans[activeService]?.map(plan => (
                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    ...
                    onClick={() => router.push('/contact')}>                      Order Now
                      <svg className="ml-2 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
                      </svg>
                    </button>
                    <button className="border border-orange-600 text-orange-600 hover:bg-orange-50 px-6 py-3 rounded-lg font-medium transition-all flex-1" onClick={() => router.push('/get-quote')}>
        ...
        <div className="mt-8 text-center text-black">
          ...
          <p className="text-sm mt-2">Need a custom solution? <a href="/contact" className="underline font-medium">Contact our team</a></p>
        </div>
      </div>
    </section>
  );
