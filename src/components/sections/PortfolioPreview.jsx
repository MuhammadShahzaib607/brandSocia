    ...
    <section 
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          >
            <span className="text-lg md:text-xl font-semibold text-primary-600 bg-primary-50 px-6 py-3 rounded-full shadow-sm">
               Our Creations
            </span>
          </motion.div>
          <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-clip-text bg-gradient-to-r from-gray-800 to-gray-600">
            Featured Projects
          </h2>
