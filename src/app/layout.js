...
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      ...
      >
        {children}
          <Whatsapp phone="+923283389247" message="Hi, I want to know more!" className="fixed bottom-10 right-2" />
        <script id="tawk-to" strategy="afterInteractive">
          {`
            ...
            s1.async=true;
            s1.src='https://embed.tawk.to/68d30a9f4d8826192783a5b5/1j5s62vv5';
            s1.charset='UTF-8';
