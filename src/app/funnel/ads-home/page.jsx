        ...
        <div className="container mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
            ...
            <div className="flex flex-wrap gap-4">
              {!isAuthorized ? (
                <Link href="/funnel/lead-form" className="bg-orange-600 hover:bg-orange-500 px-8 py-4 rounded-xl font-bold flex items-center gap-2 group shadow-xl shadow-orange-600/20 transition-all">Request Proposal <FiArrowRight className="group-hover:translate-x-1 transition-transform" /></Link>
              ) : (
                <button onClick={() => router.push("/funnel/lead-dashboard")} className="bg-[#161616] border border-white/10 hover:border-orange-500/50 px-8 py-4 rounded-xl font-bold flex items-center gap-2 transition-all cursor-pointer"><FiGrid className="text-orange-500" /> Lead Dashboard</button>
              )}
            </div>
          </motion.div>
