...
const LeadDashboard = () => {
  ...
  // Local storage/Session storage check for Next.js
  ...
  const deleteLead = async (id) => {
    ...
    try {
      ...
      setLeads(originalLeads); // Error ki surat mein wapas le aayein
    ...
    <div className="min-h-screen bg-[#0f0f0f] text-white font-sans p-4 md:p-10 selection:bg-orange-500">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
          ...
          <Link href="/adsHome" className="flex items-center justify-center gap-2 bg-[#161616] border border-white/5 px-6 py-3 rounded-xl hover:border-orange-500/50 transition-all text-xs font-black uppercase tracking-widest cursor-pointer">
